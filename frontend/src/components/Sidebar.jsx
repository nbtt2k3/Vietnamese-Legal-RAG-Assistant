...
const Sidebar = ({ currentConversationId, onSelectConversation }) => {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-sidebar-width glass-sidebar border-r border-outline-variant z-50 flex flex-col">
      <div className="p-stack-md flex items-center justify-center gap-stack-sm mb-stack-md mt-2">
        <span className="material-symbols-outlined text-secondary text-[32px]">balance</span>
        <span className="font-headline-sm text-primary tracking-tight">Tra Cứu Luật</span>
      </div>
          ...
          conversations.map(conv => {
            ...
            return (
              <div 
                ...
                className={`group flex items-center px-3 py-3 rounded-xl cursor-pointer mb-1.5 transition-all ${
                  isActive 
